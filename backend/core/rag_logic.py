...
class LegalRAG:
    ...
    def __init__(self):
        ...
        llm_model = config("OLLAMA_LLM_MODEL", default="deepseek-r1:8b")
        embed_model = config("OLLAMA_EMBED_MODEL", default="mxbai-embed-large")
    ...
    def ingest_file(self, file_path: str) -> str:
        ...
        if file_path.endswith(".pdf"):
            ...
            return "Formato de archivo no soportado. Usa .pdf o .txt"
    ...
    def query(self, question: str) -> str:
        ...
        if not self.vector_store:
            return "No tengo leyes en mi base de conocimiento todavía."
